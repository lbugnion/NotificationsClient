    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public async Task Initialize()
        {
            ...
            if (string.IsNullOrEmpty(SettingsVm.Model.FunctionsAppName)
                || string.IsNullOrEmpty(SettingsVm.Model.GetConfigurationFunctionCode))
            {
        ...
        private void SettingsPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == nameof(Settings.FunctionsAppName)
                || e.PropertyName == nameof(Settings.GetConfigurationFunctionCode))
            {
                SettingsVm.Model.IsRegisteredSuccessfully = false;
            }
        }
        ...
        private async void ClientNotificationReceived(object sender, NotificationEventArgs args)
        {
            ...
            await Task.Run(async () =>
            {
                ...
                Dispatcher.CheckBeginInvokeOnUI(() =>
                {
                    Nav.NavigateTo(ViewModelLocator.NotificationsPageKey, notificationVm);
                });
            });
        }
